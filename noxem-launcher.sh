...
export ENABLE_QUERY_REWRITE=${ENABLE_QUERY_REWRITE:-true}
export ENABLE_SMART_EXTRACT=${ENABLE_SMART_EXTRACT:-true}
export ENABLE_PROACTIVE_ADVISOR=${ENABLE_PROACTIVE_ADVISOR:-true}
export ADVISOR_INTERVAL=${ADVISOR_INTERVAL:-10}
export REWRITE_TIMEOUT_MS=${REWRITE_TIMEOUT_MS:-3000}
export EXTRACT_DEBOUNCE_MS=${EXTRACT_DEBOUNCE_MS:-2000}
