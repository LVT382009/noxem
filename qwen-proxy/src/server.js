...
const { disableNativeTools } = require('./utils/request.js')
...
const { router: filesRouter } = require('./routes/files.js')
...
// Disable Qwen native tools so they don't interfere with our JSON-tag tool calling
setTimeout(() => { disableNativeTools() }, 3000)
